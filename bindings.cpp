...
PYBIND11_MODULE(nuclear_fusion, m) {
    ...
    py::class_<nf::Brush>(m, "Brush")
        ...
        .def("set_palette", static_cast<void (nf::Brush::*)(const std::vector<std::vector<uint8_t>>)>(&nf::Brush::set_palette));

    py::class_<nf::Vec2>(m, "Vec2")
        .def(py::init<float, float>())
        .def("rotate", static_cast<nf::Vec2 (nf::Vec2::*)(float, const nf::Vec2&, bool) const>(&nf::Vec2::rotate),
